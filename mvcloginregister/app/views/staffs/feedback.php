...
<head>
    ...
    <link rel="stylesheet" href="<?php echo URLROOT; ?>/css/staffs/feedback.css">
    <style>
        body {
            ...
            <table>
                ...
                <?php else: ?>
                    <?php foreach ($data['feedbacks'] as $feedback): ?>
                        <tr>
                            <td><a href="<?php echo URLROOT; ?>/staffs/student/<?php echo $feedback->Student->StudentID; ?>"><?php echo $feedback->User->Name; ?></a></td>
                ...
                <tr>
                    <td colspan="3" style="text-align: center;">
                        ...
                        <button class="button" onclick="location.href='<?php echo URLROOT; ?>/staffs/all_events'"><i class="fas fa-arrow-left"></i> Back</button>
                    </td>
                </tr>
            </table>
        </div>
