...
<body>
    <div class="container8">
        ...
        <form action="<?php echo URLROOT; ?>/staffs/changepassword" method="post">
        ...
        <div class="button-container">
            <a href="<?php echo URLROOT; ?>/staffs/profile" class="back-button"><i class="fas fa-arrow-left icon"></i>Back</a>
        </div>
