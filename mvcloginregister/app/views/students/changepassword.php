...
<body>
    <div class="container8">
        ...
        <form action="<?php echo URLROOT; ?>/students/changepassword" method="post">
        ...
        <div class="button-container">
            <a href="<?php echo URLROOT; ?>/students/profile" class="back-button"><i class="fas fa-arrow-left icon"></i>Back</a>
        </div>
